...
const _loadLayoutFromData = (weatherData) => {
    ...
    mainDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'MMMM yyyy');

    const subtitleDate = document.querySelector('.weather-title-subtitle');
    subtitleDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 'EEEE, MMM d, yyyy');
