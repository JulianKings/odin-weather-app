...
/* harmony import */ var _images_alert_triangle_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../images/alert-triangle.svg */ "./src/images/alert-triangle.svg");
...
const _loadLayoutFromData = (weatherData) => {
    ...
    mainDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'MMMM yyyy');

    const subtitleDate = document.querySelector('.weather-title-subtitle');
    subtitleDate.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'EEEE, MMM d, yyyy');
...
const _notifyInvalidLocation = () => {
    ...
    imageIcon.src = _images_alert_triangle_svg__WEBPACK_IMPORTED_MODULE_1__;
...
const updateLayout = () =>
{
    ...
    (0,_weatherManager__WEBPACK_IMPORTED_MODULE_0__["default"])(location).then((weatherData) => {
...
module.exports = __webpack_require__.p + "569aa203c0098cc82f17.svg";
